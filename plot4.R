...
par(mfrow=c(2,2))
# First plot
plot(data$Date_Time,data$Global_active_power,type="l",xlab="",ylab="Global Active Power",cex.axis=0.7,cex.lab=0.7)
# Second plot
plot(data$Date_Time,data$Voltage,type="l",xlab="datetime",ylab="Voltage",cex.axis=0.7,cex.lab=0.7)
# Third plot
# Plot sub_metering_1
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1),col=c("black","red","blue"),cex=0.5,bty="n")
# Forth plot
plot(data$Date_Time,data$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power",cex.axis=0.7,cex.lab=0.7,lwd=0.1)
# Save figure
